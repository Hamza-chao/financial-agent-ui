...
const TypingIndicator = () => (
    <div className="flex items-start gap-3 mb-6">
        <AiIcon />
        <div className="bg-slate-200 p-4 rounded-lg rounded-tl-none chat-bubble">
...
export default function FinancialAnalystPage() {
    const [messages, setMessages] = useState<Message[]>([
        { role: 'assistant', text: "Hello! I'm your AI Financial Analyst. I can provide stock prices, company news, and market analysis. How can I help you today?" }
    ]);
    ...
    return (
        <>
            <style jsx global>{`
                ...
                .example-prompt { transition: transform 0.2s ease, box-shadow 0.2s ease; }
                    ...
                    <div className="p-4 bg-white border-t border-slate-200 rounded-b-2xl">
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                className="flex-1 p-3 bg-white border border-slate-300 text-black placeholder-slate-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition"
                                value={userInput}
                            ...
                            <button
                                id="send-button"
                                className="bg-blue-600 text-white w-12 h-12 rounded-lg flex items-center justify-center hover:bg-blue-700 transition shadow disabled:bg-slate-400"
