                        ...
                        {messages.length === 1 && (
                             <div className="my-8 text-center">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left">
                                    ...
                                    <div className="example-prompt bg-white p-3 border border-slate-200 rounded-lg cursor-pointer" onClick={() => handleExampleClick('Compare AAPL and MSFT')}>
                                        <p className="font-semibold text-slate-700">Compare Stocks</p>
                                        <p className="text-sm text-slate-500">Apple vs. Microsoft</p>
                                    </div>
                                </div>
                            </div>
                        )}
